...
func TestVersionsAfter(t *testing.T) {
	tests := []struct {
		...
		{name: "V17", version: V17, want: []version{V17, V18, V19, V20, V21, V22, V23, V24, V25, V26, V27}},
		{name: "V18", version: V18, want: []version{V18, V19, V20, V21, V22, V23, V24, V25, V26, V27}},
		{name: "V19", version: V19, want: []version{V19, V20, V21, V22, V23, V24, V25, V26, V27}},
		{name: "V20", version: V20, want: []version{V20, V21, V22, V23, V24, V25, V26, V27}},
