...
func getActorParser(actorParserFn any) actors.ActorParserInterface {
	...
	cache.On("GetActorCode", mock.Anything, mock.Anything, mock.Anything, mock.Anything, mock.Anything).Return(actorCid.String(), nil)
	cache.On("GetActorNameFromAddress", mock.Anything, mock.Anything, mock.Anything, mock.Anything, mock.Anything).Return(manifest.MultisigKey, nil)
