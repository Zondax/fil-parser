...
import (
	...
	multisigv18 "github.com/filecoin-project/go-state-types/builtin/v18/multisig"
	multisigv19 "github.com/filecoin-project/go-state-types/builtin/v19/multisig"
...
var methods = map[string]map[abi.MethodNum]nonLegacyBuiltin.MethodMeta{
	...
	tools.V28.String(): actors.CopyMethods(multisigv18.Methods),
	tools.V29.String(): actors.CopyMethods(multisigv19.Methods),
}
